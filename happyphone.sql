...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 06, 2019 lúc 10:40 AM
...
INSERT INTO `order_detail` (`id`, `id_order`, `id_product`, `quantity`, `unit_price`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_cmt` (`user_id`),
  ADD KEY `product_cmt` (`product_id`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `orders_ibfk_1` (`id_customer`) USING BTREE;
